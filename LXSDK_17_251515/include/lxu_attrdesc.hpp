		...
		public CLxObject
{
	 ...
	 * variable type
	 */
	virtual const char *	type (CLxCommand &) { return nullptr; }
	 ...
	 */
	virtual CLxDynamicUIValue *
				uivalue (CLxCommand &) { return nullptr; }
};
...
class CLxAttributeDesc
{
	 ...
	 */
	void		chan_add_dependency (const char *channel, const char *itemtype = nullptr);
