		...
		public CLxStringParser
{
	...
	const char	 sp_peek () const override { return str_val[str_pos]; }
	void		 sp_advance () override    { str_pos++; }
};
		...
		public CLxFileParser
{
    ...
    //internal:
	const char		 sp_peek () const override { return cur_pos[0]; }
	void			 sp_advance ()    override { cur_pos++; }
	...
	bool		 fp_Open       (const char *)	override;
	void		 fp_SetMonitor (LXtObjectID)	override;
	bool		 fp_HasError   ()		override;
	LxResult	 fp_ErrorCode  ()		override;
	void		 fp_Cleanup    ()		override;
