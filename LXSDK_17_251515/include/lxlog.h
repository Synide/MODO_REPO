 ...
 * as qDebug(), as well as being output to the console through qDebug() when added.
 * 
 ...
 * primary log or the console output.  This does not affect rolling log entries.
 * 
 ...
 * 
 * This clears all entries from the subsystem.  If called on the primary subsystem,
 * all subsystems are cleared.
 * 
 * This clears a specific entry from the subsystem.  If called on the primary subsystem,
 * all subsystems are cleared.
 * 
 ...
 */
	...
	// [python] ILxLogService:PrimarySubSystem	obj Log
...
/*
 * There is also a special primary subsystem.  This is a combination of all logged entries,
 ...
 */
	...
	#define LXsLOG_PRIMARYSYS	 "primary"

/*
 * Once registered, messages can be added to the log using simple strings. Each
 * message will be added to both the primary log and to the subsystem's own internal
