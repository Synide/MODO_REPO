...
class CLxChannelUI
{
	 ...
	 */
	virtual const char *	 item_icon (CLxUser_Item &) { return nullptr; }
};
...
class CLxInstanceAssets
{
	 ...
	 */
	void		add_asset (const char *ident, const char *fileType, const char *category = nullptr, bool isSeq = false);
