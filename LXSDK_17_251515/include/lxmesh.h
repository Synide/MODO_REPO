 ...
 * of quadrangles.
 * 
 * Creates a ILxPolygonEdit object which edits polygons.
 */
 ...
 * 
 * This sets a point's position in incremental update mode.
 */
 ...
 * given a map.  It returns LXe_FALSE if the specific is unmapped and will fail
 * on continuous maps.
 * 
