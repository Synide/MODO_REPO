...
//	#define	LXsICVAL_LOCATOR_LINK_CUSTOM		"custom"
	...
	// Camera "filmFit" Channel values.
	#define LXi_CAMERA_FILMFIT_FILL			0
	#define LXi_CAMERA_FILMFIT_HORIZONTAL	1
	#define LXi_CAMERA_FILMFIT_VERTICAL		2
	#define LXi_CAMERA_FILMFIT_OVERSCAN		3
