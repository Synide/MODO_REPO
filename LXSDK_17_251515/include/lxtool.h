...
typedef struct vt_ILxPathGeneratorPacket1 ** ILxPathGeneratorPacket1ID;
typedef struct vt_ILxParticleGeneratorPacket ** ILxParticleGeneratorPacketID;
typedef struct vt_ILxParticleGeneratorPacket2 ** ILxParticleGeneratorPacket2ID;
 ...
 * 
 * 
 * The bank angle at a give parameter along the path can be read.
 * 
 * A Path Generator may have multiple curves.  Clients can 
 * access the number of curves through the "CurveCount" function.
 * Calling SetCurveIndex will cause subsequent calls to apply to the
 * given curve index.  The CurrentCurveIndex can also be read.
 */
...
typedef struct vt_ILxPathGeneratorPacket1 {
	ILxUnknown	 iunk;
	LXxMETHOD(  LxResult,
Value) (
	LXtObjectID		 self,
 ...
 * 
 * 
 * A Particle Generator may have multiple sources.  Clients can 
 * access the number of sources through the "SourceCount" function.
 * Calling SetSourceIndex will cause subsequent calls to apply to the
 * given source index.  The CurrentSourceIndex can also be read.
 */
...
typedef struct vt_ILxParticleGeneratorPacket2 {
	ILxUnknown	 iunk;
	LXxMETHOD(  int,
Count) (
	LXtObjectID		 self,
 ...
 */
	...
	#define LXiTOOLOP_MULTISOURCE  0x00000004
 ...
 */
	...
	#define LXu_PATHGENERATORPACKET		"284B625A-C82E-4103-A8E0-F7848687BD4B"
	...
	// [default] ILxPathGeneratorPacket:CurveCount = 1
	// [default] ILxPathGeneratorPacket:CurrentCurveIndex = 0	

/*
 * Retired Path Generator Interface
 */

	#define LXu_PATHGENERATORPACKET1		"AE70D946-8A9A-4A72-95EC-BFF856391D22"
	#define	LXa_PATHGENERATORPACKET1		"pathgeneratorpacket1"
	// [local]  ILxPathGeneratorPacket
	// [export] ILxPathGeneratorPacket pathgen
	// [default] ILxPathGeneratorPacket:Length = 0
	// [default] ILxPathGeneratorPacket:Source = 0
 ...
 */
	...
	#define LXu_PARTICLEGENERATORPACKET	"EF9E8BC9-B875-40FC-8A30-D3B288CBC24C"
	#define	LXa_PARTICLEGENERATORPACKET	"particlegeneratorpacket"
	// [local]  ILxParticleGeneratorPacket
	// [export] ILxParticleGeneratorPacket partgen
	// [default] ILxParticleGeneratorPacket:Count = 0
	// [default] ILxParticleGeneratorPacket:SourceCount = 1
	// [default] ILxParticleGeneratorPacket:CurrentSourceIndex = 0 


	#define LXsP_TOOL_PARTGEN	"tool.partGenerator"

/*
 * This packet interface was been deprecated to add SourceIndex methods
 */

	#define LXu_PARTICLEGENERATORPACKET2	"36001340-F153-4B32-82A4-7DA438969371"
	#define	LXa_PARTICLEGENERATORPACKET2	"particlegeneratorpacket2"

/*
 * This packet interface was deprecated to add the Orient vector the HintBoxSet
 */

	#define LXu_PARTICLEGENERATORPACKET1	"5CDF5B58-46BF-4D78-8652-659E87E19C4B"
	#define	LXa_PARTICLEGENERATORPACKET1	"particlegeneratorpacket1"
