...
CLxQuaternion& CLxQuaternion::operator=(const CLxMatrix4& mat)
{
...
CLxMatrix4 CLxQuaternion::asMatrix() const
{
...
CLxQuaternion CLxQuaternion::Conjugated() const
{
    return CLxQuaternion(-q[QX], -q[QY], -q[QZ], q[QW]);
}

CLxQuaternion& CLxQuaternion::Conjugate()
{
    LXx_VNEG(q);  // negate first 3 values.
    return *this;
}

CLxQuaternion& CLxQuaternion::operator=(const CLxQuaternion& src)
{
    LXx_V4CPY(q, src.q);
    return *this;
}

double CLxQuaternion::lengthSquared() const
{
    return dot(*this);
}

/**@brief Return the length of the quaternion */
double CLxQuaternion::length() const
{
...
CLxQuaternion& CLxQuaternion::operator*=(const double s)
{
    LXx_V4SCL(q, s);
    return *this;
}
...
/**@brief Inversely scale this quaternion
 * @param s The scale factor */
CLxQuaternion CLxQuaternion::operator/(const double s) const
{
    CLxQuaternion retQ(*this);
    retQ *= 1.0 / s;
    return retQ;
...
CLxQuaternion& CLxQuaternion::normalize()
{
    return *this /= length();
}

CLxQuaternion CLxQuaternion::normal() const
{
...
double CLxQuaternion::dot(const CLxQuaternion& qq) const
{
    return (q[QX] * qq[QX] + q[QY] * qq[QY] + q[QZ] * qq[QZ] + q[QW] * qq[QW]);
}

// Slerp interpolates assuming constant velocity.
CLxQuaternion CLxQuaternion::slerp(const CLxQuaternion& qq, const double t) const
{
...
CLxQuaternion CLxQuaternion::operator*(const CLxQuaternion& qq)
{
    CLxQuaternion cQ;
...
CLxQuaternion CLxQuaternion::operator*(const CLxVector& vv)
{
    return CLxQuaternion(w() * vv.x() + y() * vv.z() - z() * vv.y(),
                         w() * vv.y() + z() * vv.x() - x() * vv.z(),
                         w() * vv.z() + x() * vv.y() - y() * vv.x(),
                         -x() * vv.x() - y() * vv.y() - z() * vv.z());
}

CLxQuaternion CLxQuaternion::operator+(const CLxQuaternion& qq) const
{
...
bool CLxQuaternion::operator==(const CLxQuaternion& qq) const
{
...
bool CLxQuaternion::epsilonEquals(const CLxQuaternion& other, double epsilon) const
{
...
CLxQuaternion CLxQuaternion::operator-() const
{
    return CLxQuaternion(-q[QX], -q[QY], -q[QZ], -q[QW]);
}

/**@brief Return the inverse of this quaternion */
CLxQuaternion CLxQuaternion::inverse() const
{
    return CLxQuaternion(-q[QX], -q[QY], -q[QZ], q[QW]);
}

/**@brief Return the inverse of this quaternion */
CLxQuaternion& CLxQuaternion::invert()
{
    LXx_VNEG(q);  // negate first 3 values.
    return *this;
}

const CLxQuaternion& CLxQuaternion::getIdentity()
{
    static const CLxQuaternion identityQuat(0.0, 0.0, 0.0, 1.0);
    return identityQuat;
}

double CLxQuaternion::operator[](unsigned int i) const
{
    if (i > 3)
...
double& CLxQuaternion::operator[](unsigned int i)
{
    if (i > 3)
        throw CLxResult(LXe_OUTOFBOUNDS);
    else
...
const double& CLxQuaternion::x() const
{
    return q[0];
}

/**@brief Return the y value */
const double& CLxQuaternion::y() const
{
    return q[1];
}

/**@brief Return the z value */
const double& CLxQuaternion::z() const
{
    return q[2];
}

/**@brief Return the w value */
const double& CLxQuaternion::w() const
{
    return q[3];
}
